...
def main() -> None:
    p = argparse.ArgumentParser(description="Final Wedding Music Cut XML")
    ...
    a = p.parse_args()
    res = export_final_wedding_music_cut_xml(project_root=a.project, source_folder=a.source, intent=a.intent, preset=a.preset, timebase=a.timebase, open_folder=not a.no_open)
