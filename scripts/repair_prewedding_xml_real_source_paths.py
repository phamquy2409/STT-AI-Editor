...
def main() -> None:
    ...
    a = p.parse_args()
    res = export_prewedding_xml(project_root=a.project, source_folder=a.source, intent=a.intent, preset=a.preset, fallback_clip_count=a.fallback_clip_count, open_folder=not a.no_open)
