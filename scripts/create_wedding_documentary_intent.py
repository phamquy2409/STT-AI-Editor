...
def main() -> None:
    p = argparse.ArgumentParser(description="Create wedding documentary / highlight timeline from real source files.")
    ...
    res = create_wedding_documentary_intent_timeline(
